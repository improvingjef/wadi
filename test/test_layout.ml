    ...
    ( "computes library, executable, and test artifact paths",
      fun () ->
        ...
        assert_string_equal "/tmp/wadi-layout/_wadi/build/default"
          (Layout.build_root workspace) "build root should be stable";
        assert_string_equal "/tmp/wadi-layout/_wadi/build/default/lib/core/libcore.cmxa"
          (Layout.library_archive workspace "core")
          "library archives should live in the lib target root";
        assert_string_equal "/tmp/wadi-layout/_wadi/build/default/lib/core/libcore.cma"
        ...
        assert_string_equal "/tmp/wadi-layout/_wadi/build/default/test/unit/unit"
        ...
        assert_string_equal "/tmp/wadi-layout/_wadi/build/default/exe/app/.wadi-explain"
