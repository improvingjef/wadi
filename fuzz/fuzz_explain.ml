...
let fingerprint_prefix =
  Crowbar.choose
    [
      Crowbar.const "compiler";
      Crowbar.const "backend";
      Crowbar.const "manifest";
      Crowbar.const "kind";
      Crowbar.const "target";
      Crowbar.const "dir";
      Crowbar.const "main";
      Crowbar.const "module";
      Crowbar.const "tool";
      Crowbar.const "package";
      Crowbar.const "ml";
      Crowbar.const "mli";
      Crowbar.const "dep";
      Crowbar.const "";
...
let fingerprint_value =
  Crowbar.choose
    [
      ...
      Crowbar.const "abc123";
      Crowbar.const "missing";
      Crowbar.const "";
      Crowbar.map [ Crowbar.bytes ] (fun s ->
          String.map (fun c -> if c = '\n' then '_' else c) s);
    ]
...
let fingerprint =
  Crowbar.map [ Crowbar.list fingerprint_line ] (fun lines -> String.concat "\n" lines)

let fingerprint_pair = Crowbar.map [ fingerprint; fingerprint ] (fun a b -> (a, b))
let raw_pair = Crowbar.map [ raw_bytes; raw_bytes ] (fun a b -> (a, b))
