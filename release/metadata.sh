...
WADI_MAINTAINER_EMAIL='noreply@github.com'
WADI_AUTHORS='Jef Newsom'
WADI_LICENSE='MIT'
WADI_REPOSITORY_URL='https://github.com/improvingjef/wadi'
WADI_BUG_REPORTS_URL='https://github.com/improvingjef/wadi/issues'
WADI_DEV_REPO='git+https://github.com/improvingjef/wadi.git'
WADI_HOMEBREW_TAP='improvingjef/wadi'
